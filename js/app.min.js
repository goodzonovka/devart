...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var swiper_bundle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper/bundle */ \"./node_modules/swiper/swiper-bundle.esm.js\");\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n/* harmony import */ var _fancyapps_ui__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @fancyapps/ui */ \"./node_modules/@fancyapps/ui/dist/fancybox.esm.js\");\n/* harmony import */ var _slider_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./slider.js */ \"./src/js/slider.js\");\n\r\n\r\n\r\n\r\n\r\n\r\njquery__WEBPACK_IMPORTED_MODULE_1__(function () {\r\n    let ww = jquery__WEBPACK_IMPORTED_MODULE_1__(window).width();\r\n    let modeMobile = (ww < 1199) ? true : false;\r\n\r\n    jquery__WEBPACK_IMPORTED_MODULE_1__('.menu__item.has-child').click(function (e) {\r\n        e.preventDefault();\r\n    })\r\n\r\n    jquery__WEBPACK_IMPORTED_MODULE_1__('.search').click(function () {\r\n        jquery__WEBPACK_IMPORTED_MODULE_1__(this).toggleClass('active');\r\n\r\n        jquery__WEBPACK_IMPORTED_MODULE_1__('.search-form').fadeToggle();\r\n\r\n        if (modeMobile) {\r\n            jquery__WEBPACK_IMPORTED_MODULE_1__('body').toggleClass('overflow-hidden');\r\n        }\r\n    })\r\n\r\n    jquery__WEBPACK_IMPORTED_MODULE_1__(document).mouseup(function (e) {\r\n        let block = jquery__WEBPACK_IMPORTED_MODULE_1__(\".search-form\"),\r\n            btn = jquery__WEBPACK_IMPORTED_MODULE_1__('.search');\r\n        if (!block.is(e.target)\r\n            && block.has(e.target).length === 0\r\n            && !btn.is(e.target)\r\n            && btn.has(e.target).length === 0\r\n        ) {\r\n            btn.removeClass('active');\r\n            block.fadeOut();\r\n        }\r\n    });\r\n\r\n    jquery__WEBPACK_IMPORTED_MODULE_1__('.actions__nav a').click(function (e) {\r\n        e.preventDefault();\r\n        jquery__WEBPACK_IMPORTED_MODULE_1__('.actions__nav a').removeClass('active');\r\n        jquery__WEBPACK_IMPORTED_MODULE_1__(this).addClass('active');\r\n    })\r\n\r\n    jquery__WEBPACK_IMPORTED_MODULE_1__('.faq__header').click(function () {\r\n        jquery__WEBPACK_IMPORTED_MODULE_1__(this).parent().toggleClass('active');\r\n        jquery__WEBPACK_IMPORTED_MODULE_1__(this).next().slideToggle();\r\n    })\r\n\r\n    jquery__WEBPACK_IMPORTED_MODULE_1__('.tab__button').click(function () {\r\n        let target = jquery__WEBPACK_IMPORTED_MODULE_1__(this).data('tab-target');\r\n\r\n        jquery__WEBPACK_IMPORTED_MODULE_1__(this).siblings().removeClass('active');\r\n        jquery__WEBPACK_IMPORTED_MODULE_1__(this).addClass('active');\r\n\r\n        jquery__WEBPACK_IMPORTED_MODULE_1__(this).closest('.tabs').find('.tab__content').hide();\r\n        jquery__WEBPACK_IMPORTED_MODULE_1__(target).fadeIn();\r\n\r\n        if (modeMobile) {\r\n            jquery__WEBPACK_IMPORTED_MODULE_1__('body, html').animate({\r\n                scrollTop: jquery__WEBPACK_IMPORTED_MODULE_1__(target).offset().top - jquery__WEBPACK_IMPORTED_MODULE_1__('.header').height()\r\n            }, 300)\r\n        }\r\n    })\r\n\r\n    jquery__WEBPACK_IMPORTED_MODULE_1__('.on-top').click(function () {\r\n        jquery__WEBPACK_IMPORTED_MODULE_1__(\"html, body\").animate({scrollTop: 0}, 500)\r\n    })\r\n\r\n    if (modeMobile) {\r\n        let menu = jquery__WEBPACK_IMPORTED_MODULE_1__('.menu');\r\n        let account = jquery__WEBPACK_IMPORTED_MODULE_1__('.account');\r\n\r\n        jquery__WEBPACK_IMPORTED_MODULE_1__('.m-menu__button').click(function () {\r\n            jquery__WEBPACK_IMPORTED_MODULE_1__('.m-menu').addClass('open');\r\n            jquery__WEBPACK_IMPORTED_MODULE_1__('body').toggleClass('overflow-hidden');\r\n        });\r\n        jquery__WEBPACK_IMPORTED_MODULE_1__('.m-menu__close').click(function () {\r\n            jquery__WEBPACK_IMPORTED_MODULE_1__('.m-menu').removeClass('open');\r\n            jquery__WEBPACK_IMPORTED_MODULE_1__('body').removeClass('overflow-hidden');\r\n        });\r\n        jquery__WEBPACK_IMPORTED_MODULE_1__('.menu__item.has-child .menu__link, .account__button').click(function() {\r\n            jquery__WEBPACK_IMPORTED_MODULE_1__(this).toggleClass('open').next().slideToggle();\r\n        })\r\n\r\n        jquery__WEBPACK_IMPORTED_MODULE_1__('.m-menu__content').append(jquery__WEBPACK_IMPORTED_MODULE_1__('.account'), jquery__WEBPACK_IMPORTED_MODULE_1__('.menu'));\r\n        jquery__WEBPACK_IMPORTED_MODULE_1__('.menu .dropdown, .account .dropdown').removeClass('dropdown');\r\n    }\r\n});\r\n\r\n\r\nconst slider = new _slider_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"]('slider', {})\r\n\r\nfunction updateFraction(slider) {\r\n    const {params, activeIndex} = slider;\r\n\r\n    let wrapSlider = slider.$el.closest('.inner'),\r\n        sliderNav = wrapSlider.find('.swiper-nav'),\r\n        currentSlide = activeIndex + 1,\r\n        totalSlides = slider.slides.length - params.slidesPerView + 1;\r\n\r\n    if (params.slidesPerView >= slider.slides.length) {\r\n        sliderNav.addClass('hidden');\r\n    } else {\r\n        sliderNav.removeClass('hidden');\r\n    }\r\n\r\n    if (currentSlide < 10) {\r\n        currentSlide = '0' + currentSlide;\r\n    }\r\n\r\n    if (totalSlides < 10) {\r\n        totalSlides = '0' + totalSlides;\r\n    }\r\n\r\n    wrapSlider.find('.swiper-pages__current').text(currentSlide);\r\n    wrapSlider.find('.swiper-pages__total').text(totalSlides);\r\n\r\n}\r\n\r\nvar swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\".success-stories__slider\", {\r\n    slidesPerView: 3,\r\n    spaceBetween: 30,\r\n    navigation: {\r\n        nextEl: \".success-stories .swiper-button__next\",\r\n        prevEl: \".success-stories .swiper-button__prev\",\r\n    },\r\n    breakpoints: {\r\n        // when window width is >= 320px\r\n        768: {\r\n            slidesPerView: 2,\r\n            spaceBetween: 20,\r\n        },\r\n        992: {\r\n            slidesPerView: 3,\r\n            spaceBetween: 30,\r\n        },\r\n    },\r\n    on: {\r\n        init() {\r\n            setTimeout(updateFraction, 0, this);\r\n        },\r\n        slideChange() {\r\n            updateFraction(this);\r\n        },\r\n        resize() {\r\n            updateFraction(this);\r\n        },\r\n    },\r\n});\n\n//# sourceURL=webpack://gulp/./src/js/app.js?");
